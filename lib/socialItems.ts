// The footer's social links, in the fixed order LinkedIn, Instagram, Discord, WhatsApp,
// keeping only those whose address is filled. Text only, no icons (ui-spec §9.1).
