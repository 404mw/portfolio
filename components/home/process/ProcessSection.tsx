...
// four steps: a column below `xl`, a ring beside the heading from `xl`, where the label and
// heading stay sticky.
...
import { container, stickyTitleXl } from "@/lib/styles";

export function ProcessSection() {
  return (
    <section id={sectionIds.process} className="scroll-mt-20 px-gutter">
      <div
        className={`${container} flex flex-col gap-14 border-t border-line py-section md:gap-20 xl:grid xl:grid-cols-[minmax(0,4fr)_minmax(0,8fr)] xl:items-start xl:gap-16 2xl:gap-24`}
      >
        <div data-anim="reveal" className={`flex flex-col gap-7 ${stickyTitleXl}`}>
