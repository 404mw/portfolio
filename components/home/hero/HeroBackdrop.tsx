// The hero's back layer (ui-spec §2.1.2), painted back to front: the drawn network, the light
// pool behind the head (glowing over the lines), the vignette and the grain. Decorative only.
